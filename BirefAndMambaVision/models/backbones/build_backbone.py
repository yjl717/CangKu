...
from models.backbones.mambavision.models.mamba_vision import mamba_vision_T
# from mambavision.models.mamba_vision import default_cfgs
...
def build_backbone(bb_name, pretrained=True, params_settings=''):
    ...
    # 增加mamba_vision_T作为backbone
    elif bb_name == 'mamba_vision_T':
        bb = mamba_vision_T(pretrained=pretrained, model_path='/root/autodl-tmp/BiRefByMambaVi/weights/cv/mambavision_tiny_1k.pth.tar')
