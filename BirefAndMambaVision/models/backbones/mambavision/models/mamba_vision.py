...
def _load_checkpoint(model,
    ...
    """
    # checkpoint = torch.load(filename, map_location=map_location) # old
    checkpoint = torch.load(filename, map_location=map_location, weights_only=False) # new
