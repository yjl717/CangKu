...
class Config():
    def __init__(self) -> None:
        ...
        self.sys_home_dir = [os.path.expanduser('~'), '/root/autodl-tmp/BiRefByMambaVi/'][1]   # Default, custom
        self.data_root_dir = os.path.join(self.sys_home_dir, 'dataset')
