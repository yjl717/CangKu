...
def SwinT(args,in_chans=4,pretrained=True):
    model = SwinTransformer(in_chans=in_chans,embed_dim=96, depths=[2, 2, 6, 2], num_heads=[3, 6, 12, 24], window_size=7, drop_path_rate=args.drop_path)
    if pretrained is True:
        checkpoint = torch.load(r'/home/swin/swin_tiny_patch4_window7_224_22k.pth', map_location='cpu')
